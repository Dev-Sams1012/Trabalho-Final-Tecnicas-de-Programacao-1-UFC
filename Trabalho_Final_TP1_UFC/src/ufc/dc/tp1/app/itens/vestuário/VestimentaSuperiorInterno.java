...
public abstract class VestimentaSuperiorInterno extends Item implements ILavavel, IEmprestavel {
	...
	public VestimentaSuperiorInterno(String id, String cor, String loja, Conservação conservacao, Tamanho tamanho) {
		super(id, cor, loja, conservacao, CategoriaRoupa.SUPERIOR_INTERNO);
